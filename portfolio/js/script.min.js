 ...
 (function () {
   $("document").ready(function ($) {
	...
	if($(window).width() > 992){
		...
		$('.floating-menu-btn-collapse-nav').on('click', mobileBtn);
	}
	
	function mobileBtn(){
		if($(this).hasClass('active')){
			$('.floating-menu-nav-main .nav').slideUp();			
		}
		else{
			$('.floating-menu-nav-main .nav').slideDown();
		}
		$(this).toggleClass('active');
	}
     function onScroll(event) {
         var scrollPos = $(document).scrollTop();
         $('.floating-menu-nav-main .menu-item a').each(function () {
             var currLink = $(this);
          var refElement = $(currLink.attr("href"));
          if (refElement.position().top <= scrollPos && refElement.position().top + refElement.height() > scrollPos) {
            $('.floating-menu-nav-main .menu-item').removeClass("active");
     ...
     //smoothscroll
     $('.floating-menu-nav-main  a[href^="#"], .slow_scroll-js').on('click', function (e) {
       e.preventDefault();
       $(document).off("scroll");
   ...
   $(".about_me__more_btn").click(function () {
     $(this).hide();
     $("#about_me__more").removeClass('about_me__more-hidden').addClass('about_me__more-visible');
   });
   $('.slow_scroll-js').click(function (event) {
     // event.preventDefault();
     event.preventDefault();
     var target = $(this.hash);
		 ...
		 if($(window).width() > 992){
			 $(window).scroll(function () {
			   var o = 100 * $(window).scrollTop() / ($(document).height() - $(window).height()),
				 a = $(this).scrollTop();
			   i = $(document).height() / $(window).height(), t.$menuFloating.find(".floating-menu-column > .floating-menu-row").css({
				 transform: "translateY( calc(" + o + "vh - " + a / i + "px) )"
			   })
			 })
		 }
     }
...
$("[data-fancybox]").each(function(){
	let thisUrl = $(this).attr("data-ref");
	let newUrl = "<a href='" + thisUrl + "' target='blanck'>" + thisUrl + "</a>";
	$(this).attr("data-caption", newUrl);
});